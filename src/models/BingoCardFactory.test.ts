...
describe('BingoCardFactory', () => {
  describe('create', () => {
    it('should create a Bingo75Card when type is 75', () => {
      const card = BingoCardFactory.create(BINGO_TYPES.BINGO_75);
    ...
    it('should create a Bingo90Card when type is 90', () => {
      const card = BingoCardFactory.create(BINGO_TYPES.BINGO_90);
    ...
    it('should accept custom id for Bingo75Card', () => {
      ...
      const card = BingoCardFactory.create(BINGO_TYPES.BINGO_75, customId);
    ...
    it('should accept custom id for Bingo90Card', () => {
      ...
      const card = BingoCardFactory.create(BINGO_TYPES.BINGO_90, customId);
  ...
  describe('createMultiple', () => {
    it('should create multiple Bingo75 cards', () => {
      const cards = BingoCardFactory.createMultiple(BINGO_TYPES.BINGO_75, 5);
    ...
    it('should create multiple Bingo90 cards', () => {
      const cards = BingoCardFactory.createMultiple(BINGO_TYPES.BINGO_90, 3);
    ...
    it('should create cards with unique ids', () => {
      const cards = BingoCardFactory.createMultiple(BINGO_TYPES.BINGO_75, 10);
    ...
    it('should throw error when count is less than 1', () => {
      expect(() => BingoCardFactory.createMultiple(BINGO_TYPES.BINGO_75, 0)).toThrow(
        'Count must be at least 1',
      );
      expect(() => BingoCardFactory.createMultiple(BINGO_TYPES.BINGO_75, -5)).toThrow(
        'Count must be at least 1',
      );
    });

    it('should throw error when count exceeds maximum', () => {
      expect(() => BingoCardFactory.createMultiple(BINGO_TYPES.BINGO_75, 1001)).toThrow(
        'Count exceeds maximum limit',
      );
    });

    it('should allow creating exactly 1000 cards', () => {
      const cards = BingoCardFactory.createMultiple(BINGO_TYPES.BINGO_75, 1000);
